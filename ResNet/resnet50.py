...
def Hessian_metrics(model, test_loader, threshold):
    ...
    for i, (x_batch, y_batch) in enumerate(test_loader):
        ...
        try:
            ...
            pass
    np.save("x_batches_resnet101", x_batches)
    np.save("y_batches_resnet101", y_batches)
    np.save("a_batches_resnet101", a_batches)
...
if __name__ == "__main__":
    ...
    np.save("sparse_resnet101", sparse)
    np.save("ROAD_resnet101", ROAD)
